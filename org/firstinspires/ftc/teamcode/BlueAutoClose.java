...
@Autonomous(name="BlueAutoClose", group="Opmode")
...
public class BlueAutoClose extends OpMode{
    ...
    public void init() {
        ...
        script.add(new Jewel(Jewel.Color.RED, new Time(1000)));
        ...
        script.add(new Wait(new Time(200)));
        script.add(new Drive(OmniDrive.Direction.L, new Distance(950)));
        script.add(new Drive(OmniDrive.Direction.B, new Distance(100)));
